...
class Progress {
  ...
  constructor() {
    ...
    let urls = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    let urlsPool = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
    let message = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    this.url = url;
    this.html = html;
    this.urls = urls;
