 ...
 */class Progress{/**
     ...
     */constructor(){let url=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;let html=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;let headers=arguments.length>2&&arguments[2]!==undefined?arguments[2]:null;let urls=arguments.length>3&&arguments[3]!==undefined?arguments[3]:0;let urlsPool=arguments.length>4&&arguments[4]!==undefined?arguments[4]:0;let message=arguments.length>5&&arguments[5]!==undefined?arguments[5]:null;this.url=url;this.html=html;this.headers=headers;this.urls=urls;this.urlsPool=urlsPool;this.message=message}/**
