 ...
 */class CrawlerRepository{/**
     ...
     */processPage(url){var _this2=this;return _asyncToGenerator(function*(){yield _this2.page.goto(url,{"waitUntil":"networkidle2"});const waitForRender=_this2.option.index.waitForRender;if(waitForRender){yield _this2.page.waitFor(waitForRender)}return yield _this2.page.mainFrame().content()})()}/**
